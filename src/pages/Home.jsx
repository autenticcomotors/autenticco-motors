          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-16 grid grid-cols-1 md:grid-cols-4 gap-8">
              {timelineSteps.map((step, index) => (
                <motion.div key={step.num} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.5 }} transition={{ duration: 0.5, delay: index * 0.1 }} className="text-center">
        ...
        <section className="py-24 bg-gray-900 text-white">
            <div className="max-w-4xl mx-auto px-4 text-center">
                ...
                <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
                    <Button asChild size="lg" className="bg-yellow-400 text-black font-bold text-lg px-8 py-6 hover:bg-yellow-500 transition-transform hover:scale-105"><Link to="/estoque">Quero Comprar</Link></Button>
                    <Button asChild size="lg" className="bg-black border-2 border-yellow-400 text-yellow-400 font-bold text-lg px-8 py-6 hover:bg-yellow-400 hover:text-black transition-transform hover:scale-105"><Link to="/vender">Quero Vender</Link></Button>
                </div>
            </div>
        </section>
      </div>
