...
import heroBackground from '@/assets/familia-conquista.jpg'; // troque pela ponte quando quiser
import carHero from '@/assets/car-hero.png'; // coloque aqui seu PNG transparente (src/assets/car-hero.png)
