  ...
  return (
    <div className="relative isolate min-h-screen bg-gray-50 text-gray-800 pt-28">
      <Helmet>
        ...
        <meta
          name="description"
          content="Venda seu carro com segurança e agilidade. Avaliação gratuita, processo sem burocracia e a melhor valorização do mercado. Solicite sua avaliação agora!"
        />
      </Helmet>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        >
          {/* 📱 Título mais confortável no mobile (sem overlap) */}
          <h1 className="text-3xl sm:text-4xl md:text-6xl font-extrabold text-gray-900 tracking-tight leading-tight sm:leading-tight">
            Venda seu carro com{' '}
            <span className="text-yellow-500">segurança e sem esforço</span>
          </h1>

          {/* subtítulo SEM altura fixa; deixa fluir conforme quebra de linha */}
          <div className="mt-4 sm:mt-6 text-base sm:text-lg text-gray-600 max-w-3xl mx-auto">
            <span className="block">
              Cuidamos de tudo para você, da avaliação
              profissional à documentação.
            </span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          <motion.div
            ...
            className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl border sticky top-28"
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-gray-100 border-gray-300 rounded-lg focus:ring-yellow-500 focus:border-yellow-500"
                  />
                </div>
                <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  onChange={handleInputChange}
                  placeholder="Detalhes como KM, versão, cor, estado de conservação..."
                  rows={4}
                  className="w-full px-4 py-3 bg-gray-100 border-gray-300 rounded-lg resize-none focus:ring-yellow-500 focus:border-yellow-500"
                />
              </div>
              ...
              <Button
                ...
                className="w-full bg-yellow-400 text-black font-bold py-6 text-lg hover:bg-yellow-500 transition-all duration-300 transform hover:scale-105"
              >
          ...
          >
            ...
            >
              ...
              <p className="text-gray-600 mb-6">
                Clique no botão abaixo e fale diretamente com um de nossos assessores pelo WhatsApp.
              </p>
              <Button
                asChild
                className="w-full bg-green-500 text-white font-bold py-6 text-lg hover:bg-green-600 transition-all duration-300 transform hover:scale-105"
              >
