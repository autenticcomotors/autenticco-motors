...
const CarDetail = () => {
    ...
    return (
        <>
            <Helmet>
                <title>{`${car.brand} ${car.model} - AutenTicco Motors`}</title>
            </Helmet>
                            ...
                            <div className="lg:col-span-2 flex flex-col gap-8 sticky top-28">
                                <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl border">
                                    ...
                                    <div className="space-y-4 mb-8">
                                        {specs.map(spec => (
                                            spec.value && (
                                                <div key={spec.label} className="flex items-center justify-between text-base">
                                    ...
                                    <Button onClick={() => setIsInterestModalOpen(true)} className="w-full bg-yellow-400 text-black font-bold py-6 text-lg hover:bg-yellow-500 transition-all duration-300 transform hover:scale-105 group">
                                        Tenho Interesse <ArrowRight className="ml-3 transition-transform duration-300 group-hover:translate-x-1" />
                                    </Button>
                                </div>
